...
def custom_help():
    ...
    console.print("   [cyan]diff[/cyan]        Semantic diff between two versions")
    console.print("   [cyan]test-add[/cyan]    Add a regression test case")
    console.print("   [cyan]test-run[/cyan]    Run regression tests between two versions")
    console.print("")
    console.print(" [dim]Example:[/dim]")
    console.print("   [dim]prompthub init[/dim]")
    console.print("   [dim]prompthub add my_prompt.txt[/dim]")
    console.print("   [dim]prompthub commit -m \"initial version\"[/dim]")
    console.print("   [dim]prompthub diff v1 v2[/dim]")
    console.print("")
